...
# generated by `$ nix run github:nix-community/plasma-manager`
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bbed9781-6115-4e6b-ad61-489369d31c8e" = [ ];
      ...
      "kwin"."Window Close" = ["Meta+Shift+C" "Alt+F4,Alt+F4,Close Window"];
      ...
      "plasmashell"."activate application launcher" = ["Meta+Shift+Q" "Alt+F1,Meta" "Alt+F1,Activate Application Launcher"];
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/5d61d3e1-be47-5f37-98a9-737d099ab344"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
