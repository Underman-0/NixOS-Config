...
# generated by `$ nix run github:nix-community/plasma-manager`
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bbed9781-6115-4e6b-ad61-489369d31c8e" = "none";
      ...
      "kwin"."Window Close" = ["Alt+F4" "Meta+Shift+C\\,Alt+F4\\,Close Window"];
      ...
      "plasmashell"."activate application launcher" = ["Alt+F1" "Meta+Shift+Q\\,Meta" "Alt+F1\\,Activate Application Launcher"];
      ...
      "services/org.kde.konsole.desktop"."_launch" = ["Ctrl+Alt+T" "Meta+Q"];
      "services/plasma-manager-commands.desktop"."launch-brave" = "Meta+Shift+B";
    };
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,8,21,16,8,23.049";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."bbed9781-6115-4e6b-ad61-489369d31c8e" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "bbed9781-6115-4e6b-ad61-489369d31c8e";
      ...
      "ksplashrc"."KSplash"."Theme" = "Ars-Splash-6";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "6dd71463-bcdc-49d9-8b74-460929091bd5";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/5d61d3e1-be47-5f37-98a9-737d099ab344"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      ...
      "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/underman/Pictures/Screenshots/pycharm-installed.png";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/underman/Pictures/Screenshots/pycharm-installed.png";
